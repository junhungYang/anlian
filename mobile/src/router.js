...
// import myCertificate from './pages/myCertificate.vue'
// import testInfo from './pages/testInfo.vue'
// import testRecord from './pages/testRecord.vue'
// import testEnd from './pages/testEnd.vue'
// import practise from './pages/practise.vue'
// import test from './pages/test.vue'
// import login from './pages/login.vue'
// import classInfo from './pages/classInfo.vue'
// import examSignUp from './pages/examSignUp.vue'
// import classDetail from './pages/classDetail.vue'
// import signUp from './pages/lessonSignUp/signUp.vue'
// import myOrder from './pages/lessonSignUp/myOrder.vue'
// import orderDetail from './pages/lessonSignUp/orderDetail.vue'
// import adminLogin from './pages/search/adminLogin.vue'
// import search from './pages/search/search.vue'
// import certificateSearch from './pages/search/certificateSearch.vue'
...
const signUpRecord = r => require.ensure([], () => r(require('./pages/signUpRecord.vue')), 'lessonSignUp')
